...
# console.dev/console-application-operator-bundle:$VERSION and console.dev/console-application-operator-catalog:$VERSION.
...
GOLANGCI_SETTINGS = $(shell pwd)/.golangci.yml
...
lint: golangci-lint ## Run golangci-lint linter & yamllint
	$(GOLANGCI_LINT) run -v --config $(GOLANGCI_SETTINGS)
